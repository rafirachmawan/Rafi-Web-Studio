  ...
  return (
    <section className="relative h-screen flex items-center justify-center px-6 overflow-hidden">
      ...
      >
        <motion.p
          variants={FADE_UP}
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-400/30 bg-purple-500/20 backdrop-blur-sm mb-6"
        >
          <span className="w-2 h-2 rounded-full bg-purple-400 animate-pulse" />
          <span className="text-purple-300 tracking-[0.4em] uppercase text-xs md:text-sm font-bold">
            ⭐ CROWN VICTORIA HOTEL TULUNGAGUNG
          </span>
        </motion.p>
        <motion.h1
          variants={FADE_UP}
          className="text-4xl sm:text-6xl md:text-7xl font-serif font-black leading-tight mb-8 text-white drop-shadow-2xl"
        >
        ...
        <motion.p
          variants={FADE_UP}
          className="text-sm md:text-lg lg:text-xl text-zinc-300 font-light max-w-2xl mx-auto mb-12 leading-relaxed"
        >
