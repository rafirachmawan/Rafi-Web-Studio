  ...
  return (
    <>
      <div id="harga" className="mt-32 mb-24 max-w-6xl mx-auto text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm md:text-base max-w-2xl mx-auto mt-4 mb-8">
            ...
            <button
              ...
              className={`px-4 py-1.5 md:px-5 md:py-2 rounded-full text-xs md:text-sm font-medium transition-all duration-300 border ${
                pricingTab === item.value
                  ...
                  : "bg-black/[0.03] dark:bg-white/10 text-gray-700 dark:text-gray-300 border-black/10 dark:border-white/10 hover:bg-black/[0.06] dark:hover:bg-white/20 hover:scale-105"
              }`}
            >
              {item.label}
            </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          {pricingTab === "landing" && (
            <>
              <div className="bg-black/[0.03] dark:bg-white/[0.03] border border-black/10 dark:border-white/10 rounded-3xl p-6 flex flex-col justify-between min-h-[260px]">
                <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 text-xs space-y-1 mb-4">
                    <li>✔ 1 Halaman</li>
                    <li>✔ Desain Modern</li>
              ...
              <div className="bg-black/[0.05] dark:bg-white/[0.05] border border-amber-400/40 rounded-3xl p-8">
          ...
          {pricingTab === "company" && (
            <>
              ...
              {/* Company Pro */}
              <div className="bg-black/[0.05] dark:bg-white/[0.05] border border-amber-400/40 rounded-3xl p-6 flex flex-col justify-between min-h-[260px]">
                <div>
                  <h3 className="text-base md:text-lg font-semibold mb-2 text-black dark:text-white">
                    Company Pro
                  </h3>
          ...
          {/* CUSTOM */}
          {pricingTab === "custom" && (
            <div className="col-span-2 bg-black/[0.03] dark:bg-white/[0.03] border border-black/10 dark:border-white/10 rounded-3xl p-10 text-center">
              <h3 className="text-2xl font-semibold mb-4 text-black dark:text-white">
                Custom Project
              </h3>
