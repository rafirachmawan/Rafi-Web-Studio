    ...
    <div className="mb-24">
      <div className="grid md:grid-cols-3 gap-10 items-center">
        ...
        <div className="space-y-4 order-2 md:order-1">
          {/* ITEM */}
          <div className="group relative flex items-start gap-4 p-4 rounded-xl bg-black/[0.03] dark:bg-white/[0.02] border border-black/5 dark:border-white/5 hover:border-red-400/30 transition hover:-translate-y-0.5 overflow-hidden">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm md:text-base leading-relaxed group-hover:text-black dark:group-hover:text-white transition">
      ...
      {/* BOTTOM */}
      <div className="mt-12 max-w-3xl mx-auto bg-black/[0.03] dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl px-6 py-6 text-center">
