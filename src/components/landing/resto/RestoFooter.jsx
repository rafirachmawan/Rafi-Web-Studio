...
export function RestoFooter() {
  return (
    <footer className="bg-stone-100 border-t border-stone-200 pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center justify-center text-center mb-12">
          ...
          <div className="flex gap-8 mb-12 text-[10px] tracking-widest uppercase font-bold text-zinc-500">
            ...
            <a href="#" className="hover:text-[#db2777] transition-colors">Locations</a>
            <a href="#" className="hover:text-[#db2777] transition-colors">Franchise</a>
          </div>
        </div>
