      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24 md:pt-40 md:pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-7 space-y-12 md:space-y-16">
            ...
            >
              <h2 className="text-2xl font-bold mb-6 text-black dark:text-white">Gambaran Proyek</h2>
            ...
            <motion.section
              ...
              viewport={{ once: true, margin: "-100px" }}
            >
              <h2 className="text-2xl font-bold mb-6 text-black dark:text-white">Fitur Unggulan</h2>
              <ul className="space-y-4">
                {project.features ? project.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start gap-4">
                    ...
                    <span className="text-lg font-medium text-zinc-700 dark:text-zinc-300 leading-relaxed">{feature}</span>
                  </li>
                )) : (
                  <li className="text-zinc-500">Detail fitur sedang disiapkan...</li>
                )}
              </ul>
            </motion.section>
