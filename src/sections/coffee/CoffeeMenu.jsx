      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-400 text-sm max-w-md mx-auto leading-relaxed">
            Discover a wide selection of signature beverages, delicious food, 
            and exclusive merchandise available at all Starbucks Indonesia stores.
          </p>
        </div>
            ...
            {menuItems.map((item, index) => (
              ...
              >
                ...
                <div className="border-t border-white/5 pt-4 mt-2 flex items-center justify-between text-[10px] text-zinc-500 font-semibold uppercase tracking-wider relative z-20">
                  <span>
                    {item.hotIced?.length ? 'Available Hot / Iced' : 'Served Warm'}
                  </span>
                  <span className="text-[#00704A] font-bold">Original</span>
                </div>
              </motion.div>
            ))}
          </motion.div>
