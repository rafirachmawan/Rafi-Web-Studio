    ...
    <section className="py-24 px-6 bg-gradient-to-b from-[#0f0f13] to-[#0a0a0c]">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-amber-500/30 bg-amber-500/10 mb-6">
                ...
                <span className="text-amber-500 text-xs font-bold uppercase tracking-widest">Our Excellence</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-serif font-black text-white mb-6 tracking-tight">
                Setting the Standard<br />for Luxury Hospitality
              </h2>

              <p className="text-zinc-400 text-sm leading-relaxed mb-8">
                Dengan lebih dari 10 tahun pengalaman dalam industri perhotelan, Crown Victoria Hotel terus berkomitmen memberikan pengalaman menginap terbaik dengan sentuhan Victorian yang autentik.
              </p>
              ...
              <div className="grid grid-cols-2 gap-6">
                {stats.map((stat, index) => (
                  <motion.div
                    ...
                    className="p-4 bg-[#0a0a0c] border border-zinc-800 rounded-xl"
                  >
              ...
              <div className="mt-8 flex items-center gap-4">
                <div className="flex items-center gap-2 p-3 bg-[#0a0a0c] border border-zinc-800 rounded-lg">
                  <Award className="w-5 h-5 text-amber-500" />
                  <div>
                    <div className="text-white text-xs font-bold">4-Star Hotel</div>
                    <div className="text-zinc-600 text-[10px]">Official Rating</div>
                  </div>
                </div>
                <div className="flex items-center gap-2 p-3 bg-[#0a0a0c] border border-zinc-800 rounded-lg">
                  <Users className="w-5 h-5 text-amber-500" />
                  <div>
                    <div className="text-white text-xs font-bold">Top Rated</div>
                    <div className="text-zinc-600 text-[10px]">Guest Choice 2024</div>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            {/* Main Image */}
            <div className="col-span-2 bg-[#0a0a0c] border border-zinc-800 rounded-xl overflow-hidden">
