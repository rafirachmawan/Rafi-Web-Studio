          ...
          <div>
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/30 bg-purple-500/10 mb-6">
                ...
                <span className="text-purple-600 text-xs font-bold uppercase tracking-widest">Our Excellence</span>
              </div>
              ...
              <div className="mt-8 flex items-center gap-4">
                <div className="flex items-center gap-2 p-3 bg-white border border-zinc-200 rounded-lg shadow-sm">
                  ...
                  <div>
                    <div className="text-zinc-900 text-xs font-bold">4-Star Hotel</div>
                    <div className="text-zinc-500 text-[10px]">Official Rating</div>
                  </div>
                </div>
                <div className="flex items-center gap-2 p-3 bg-white border border-zinc-200 rounded-lg shadow-sm">
                  <Users className="w-5 h-5 text-purple-600" />
                  <div>
                    <div className="text-zinc-900 text-xs font-bold">Top Rated</div>
                    <div className="text-zinc-500 text-[10px]">Guest Choice 2024</div>
                  </div>
                </div>
              </div>
            </motion.div>
