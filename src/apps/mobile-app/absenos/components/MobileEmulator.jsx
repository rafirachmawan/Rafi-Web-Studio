...
export default function MobileEmulator({ children }) {
  return (
    <div className="flex items-center justify-center py-10 px-4 bg-zinc-950/20 rounded-[3rem] border border-white/5 backdrop-blur-md">
      <div className="relative">
        {/* PHYSICAL CASE */}
        <div className="relative w-[320px] h-[650px] md:w-[380px] md:h-[780px] bg-[#1a1a1b] rounded-[3.5rem] p-3 shadow-[0_0_100px_rgba(0,0,0,0.5)] border-[8px] border-[#2a2a2b] overflow-hidden">
          ...
          <div className="w-full h-full bg-black rounded-[2.8rem] overflow-hidden relative border border-white/10">
            ...
            {/* DYNAMIC ISLAND */}
            <div className="absolute top-2 left-1/2 -translate-x-1/2 w-28 h-7 bg-black rounded-full z-[100] flex items-center justify-between px-4">
            ...
            {/* STATUS BAR */}
            <div className="absolute top-0 left-0 w-full h-10 px-8 flex items-center justify-between z-[90] text-[10px] font-bold text-white/90">
               <span>9:41</span>
