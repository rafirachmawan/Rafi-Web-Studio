...
- Price text: `text-amber-600` → `text-purple-600`
- Check icons: `text-amber-600` → `text-purple-600`
...
- Title hover: `group-hover:text-amber-600` → `group-hover:text-purple-600`
...
- CTA button hover: `hover:border-amber-600` → `hover:border-purple-600`
...
- Avatar gradients: `from-amber-100` → `from-purple-100`
- Avatar borders: `border-amber-200` → `border-purple-200`
...
1. `/src/constants/themes.js` - Theme configuration
2. `/src/components/landing/LandingNavbar.jsx` - Navbar logo and buttons
3. `/src/sections/hotel/HotelRooms.jsx` - Rooms section
4. `/src/sections/hotel/HotelFacilities.jsx` - Facilities section
5. `/src/sections/hotel/HotelGallery.jsx` - Gallery section
6. `/src/sections/hotel/HotelTestimonials.jsx` - Testimonials section
7. `/src/sections/hotel/HotelCTA.jsx` - CTA section
8. `/src/components/landing/hotel/HotelFooter.jsx` - Footer

**Total:** ~57 lines changed across 8 files

---

## ✨ What Remains Unchanged

✅ Light theme background (`#FDFDFD → #E8EEF7`)
✅ White card backgrounds
✅ Zinc900/Zinc600 text colors
✅ Border zinc-200
...
The hotel landing page now features a beautiful purple/violet color scheme while maintaining the clean light theme aesthetic!
